...
type
  ...
  public
    ...
    procedure info(data1, data2: array of Variant); overload;
		procedure info(data1, data2, data3: array of Variant); overload;
		procedure info(data1, data2, data3, data4: array of Variant); overload;
    procedure info(data1: Variant; data2: array of Variant); overload;
    procedure info(data1: array of Variant; data2: Variant); overload;
    ...
    procedure log(data1, data2: Variant); overload;
		...
		procedure log(data1, data2, data3, data4: Variant); overload;
		procedure log(data1, data2, data3, data4, data5: Variant); overload;
    procedure log(data: array of Variant); overload;
    procedure log(data1, data2: array of Variant); overload;
		procedure log(data1, data2, data3: array of Variant); overload;
		procedure log(data1, data2, data3, data4: array of Variant); overload;
    procedure log(data1: Variant; data2: array of Variant); overload;
    procedure log(data1: array of Variant; data2: Variant); overload;
    ...
    procedure trace; overload;
    procedure trace(data: Variant); overload;
    procedure trace(data1, data2: Variant); overload;
		procedure trace(data1, data2, data3: Variant); overload;
    procedure trace(data: array of Variant); overload;
    procedure trace(data1, data2: array of Variant); overload;
		procedure trace(data1, data2, data3: array of Variant); overload;
    procedure trace(const data: array of const); overload;
    procedure trace(const data1, data2: array of const); overload;
		procedure trace(const data1, data2, data3: array of const); overload;
